...
ISEStep( "map",
         "-intstyle pa -w -ignore_keep_hierarchy -r 4 -ol high -xe n \"v6pcieDMA.ngd\"" );
ISEStep( "par",
         "-intstyle pa \"v6pcieDMA.ncd\" -w \"v6pcieDMA_routed.ncd\" -ol high" );
ISEStep( "trce",
         "-intstyle ise -o \"v6pcieDMA.twr\" -v 3 -l 30 -nodatasheet -fastpaths \"v6pcieDMA_routed.ncd\" \"v6pcieDMA.pcf\"" );
ISEStep( "xdl",
         "-secure -ncd2xdl -nopips \"v6pcieDMA_routed.ncd\" \"v6pcieDMA_routed.xdl\"" );
